...
retriever = docsearch.as_retriever(search_type="similarity", search_kwargs={"k":3})  #search_type="similarity tìm kiếm theo cosin  ,  as_retrieve biến docsearch thành bộ tìm kiếm , .. k =3 -> tìm 3 giá trị gần nhất
